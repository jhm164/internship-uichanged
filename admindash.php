                        ...
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider">
                                Menu
                                                           ...
                                                           <li class="nav-item">
                                            <a class="nav-link" href="admindash.php"><i class="fa fa-fw fa-user-circle"></i>Admin Dashboard<span class="badge badge-secondary">New</span></a>
                                        </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="align-self: center;">
                                        ...
                                        <div class="metric-value d-inline-block" style="">
                                         
                                             
                                            
                                             <h4> Total Orders:<?php echo $total; ?></h4>
                                                <h4>    Current Orders:<?php echo $ordered; ?></h4>
                                               <h4>    Delivered Orders:<?php echo $delivered; ?></h4>
                                               <h4>    Despatch Orders:<?php echo $shipped; ?></h4>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">Rs.<?php echo $totalprice; ?></h1>
                                        </div>
