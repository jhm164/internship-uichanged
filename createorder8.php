                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/createorder8.php">Create New<span class="badge badge-secondary">New</span></a>
                                        </li>
...
<div id="manual" style="margin-top: 10px;">
      ...
      <form id="upload_form" enctype="multipart/form-data" method="post">
  <input type="file"  class="btn btn-secondary"  name="file1" id="file1">
  <br><br>
